...
then
	...
	cat tmp   | dot -Kneato -n -y -Tsvg -Efontname="Arial" -Nlabel="" -Nwidth=1 -Nheight=1 -Npenwidth=20 -Epenwidth=20 -Nstyle="filled"> test.svg

	echo "converting to a svg file"
	cat tmp   | dot -Kneato -n -y -Tpdf -Efontname="Arial" -Nlabel="" -Nwidth=1 -Nheight=1 -Npenwidth=20 -Epenwidth=20 -Nstyle="filled"> test.pdf
